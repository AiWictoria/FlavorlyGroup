      ...
      <Table responsive variant="light" className="table-custom">
        <thead>
          <tr>
            ...
            >
              <div
                className="header-cell-content justify-content-center"
              ...
              >
                ...
                <i
                  ...
                  style={{ visibility: statusSort ? "visible" : "hidden" }}
                ></i>
              </div>
            </th>
            ...
            <th className="date-column" style={{ minWidth: "160px" }}>
              ...
              >
                ...
                <i
                  ...
                  style={{ visibility: dateSort ? "visible" : "hidden" }}
                ></i>
              </div>
            </th>
          ...
          {getSortedOrders(orders).map((order: Order) => (
            <tr key={order.id} style={{ backgroundColor: "#ededed" }}>
              ...
              <td
                ...
                style={{ width: "140px", backgroundColor: "#ededed" }}
              >
              ...
              <td
                ...
                style={{ minWidth: "160px", backgroundColor: "#ededed" }}
              >
                {formatDate(order.date)}
              </td>
              <td
                className="actions-column"
                style={{ width: "200px", backgroundColor: "#ededed" }}
              >
