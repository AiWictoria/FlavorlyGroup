...
public static class FieldValidator
{
        ...
        YesSql.ISession session)
    {
        ...
        var cleanObjects = await GetRoutes.FetchCleanContent(contentType, session, populate: false, useNewCleaner: true, maxPopulationDepth: 2);
        ...
        cleanObjects = await GetRoutes.FetchCleanContent(contentType, session, populate: false, useNewCleaner: true, maxPopulationDepth: 2);
